...
<div id="topMenu">
    <div id="backToMenu">
        <a class="backToMenuLink" href="index.php"> Powrót do menu </a>
    </div>
    <div id="topLogo">
...
<div id="footer">
    ...
    <p id="aboutFilms1">
        <!-- Nagrania pochodzą ze strony słownika <a href="http://www.slownikpjm.uw.edu.pl/">http://www.slownikpjm.uw.edu.pl/</a> -->
    </p>
    <p id="aboutFilms2">
        <b>Nagrania</b>:
